 ...
 *******************************************************************************/
package com.agitation.sport.functional;
...
import com.agitation.sport.SportStartServer;
...
public class BaseFunctionalTestCase {
	...
	protected static void startJettyOnce() throws Exception {
		if (jettyServer == null) {
			...
			jettyServer = JettyFactory.createServerInSource(new URL(baseUrl).getPort(), SportStartServer.CONTEXT);
